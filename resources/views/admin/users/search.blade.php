  ...
  <section class="content">
        <div class="box">
          ...
          <form action="{{route('users.search')}}" id="form" method="get" style="margin-bottom: 30px">
            ...
            <a @if(auth()->user()->hasPermission('admins_update')) href="{{route('users.edit',['id'=>$users->id])}}" @else href="#" disabled  @endif class="btn btn-success" ><strong><i class="fa fa-edit"></i> {{__('trans_word.Edit')}}</strong></a>
...
@section('contentjs')
  <script>
      ...
      $(document).on('click','.delete',function(e){
          ...
          var r= confirm("Are you sure delete the user!");
          if(r==true){
          $.ajax({
              method:"delete",
